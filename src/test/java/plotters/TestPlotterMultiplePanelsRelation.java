...
public class TestPlotterMultiplePanelsRelation {
    ...
    public static void main(String[] args) {
        ...
        PlotterMultiplePanelsPairs plotter0=new PlotterMultiplePanelsPairs("pos","value");
        plotter0.plot(listOfDataPairs0);

        List<List<Pair<Double,Double>>> listOfDataPairs=List.of(dataPairs1,dataPairs2);
        PlotterMultiplePanelsPairs plotter1=new PlotterMultiplePanelsPairs("pos","value");
