...
public class RunCartPoleAlphaZero {
    ...
    private static void renderGraphics(NetworkMemoryInterface<CartPoleVariables,Integer> memory,
    ...
    private static ReplayBufferValueSetter<CartPoleVariables,Integer> trainMemoryFromEpisode(NetworkMemoryInterface<CartPoleVariables,Integer> memory,
        ...
        CartPoleMemoryTrainer memoryTrainerHelper = new CartPoleMemoryTrainer(MINI_BATCH_SIZE, MAX_ERROR, MAX_EPOCHS);
