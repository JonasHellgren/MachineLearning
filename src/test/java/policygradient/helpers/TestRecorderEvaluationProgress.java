...
import policy_gradient_problems.helpers.RecorderEvaluationProgress;
...
class TestRecorderEvaluationProgress {

    RecorderEvaluationProgress recorder;

    @BeforeEach
    public void init() {
        recorder =new RecorderEvaluationProgress();
    }
