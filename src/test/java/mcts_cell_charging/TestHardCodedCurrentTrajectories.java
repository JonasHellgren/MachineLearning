...
public class TestHardCodedCurrentTrajectories {
    ...
    public void moderateCurrentTrajectoryGivesNoViolation() {
        ...
        Assert.assertTrue(resultsList.get(nofResultItems-1).getVoltage()<cellSettings.getMaxVoltage());
        Assert.assertTrue(resultsList.get(nofResultItems-1).getNewTemperature()<cellSettings.getMaxTemperature());
    }
