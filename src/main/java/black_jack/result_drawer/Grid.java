...
//https://math.hws.edu/eck/cs124/s14/lab7/lab7-files/Grid.java
...
public class Grid extends JPanel implements MouseListener {
    ...
    public static void main(String[] args) {
        ...
        Grid content = new Grid(20,20,30);  // Create an object of type Grid.
    ...
    /**
     * A mouse-handling method that is called when the user presses the mouse at some pixel
     * in the panel.  In this case, the grid square where the user clicked is assigned
     * a random color, and the panel is repainted to show the change.
     */
